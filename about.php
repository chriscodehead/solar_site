...
$active2 = 'active';
$title = 'About | We provide the first-class solar energy solutions to families and businesses across the - ' . $siteName;
...
<body>
  ...
  <div class="page">
    ...
    <section class="section section-md bg-image context-dark" style="background-image: url(images/about-01-1920x800.jpg)">
      <div class="container">
        <div class="row">
          <div class="col-xl-9">
            <h1>We Provide Innovative Solar Energy Solutions</h1>
            <p class="small text-gray font-weight-medium">Our motto</p>
            <h4 class="text-primary">“Making solar & alternative energy <br class="d-none d-sm-block"> affordable throughout the Globe”</h4>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section-lg bg-light">
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-md-5 pb-5"><img src="img/team3.jpg" alt="" width="460" height="280" loading="lazy" />
          </div>
          <div class="col-lg-6">
            <h2>About Us</h2>
            <p>
              Welcome to <?php print $siteName; ?> – Your Partner in Sustainable Energy Solutions!
            </p>
            <p>At <?php print $siteName; ?>, we are passionate about harnessing the power of renewable energy to create a greener and more sustainable future. As a leading solar and wind turbine installation contracting company, we specialize in providing innovative and eco-friendly energy solutions to residential, commercial, and industrial clients.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section-lg bg-white text-center">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-12 pb-5"><img src="img/team1.png" alt="" width="" height="" loading="lazy" /></div>
          <div class="col-xl-9">
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-xl-8 col-md-10">
            <h2>Our Difference <br class="d-none d-xl-block"> from Other Solar Power Companies</h2>
            <p></p>
          </div>
        </div>
        <div class="row row-30 offset-md">
          <div class="col-lg-4 col-sm-6">
            <article class="post-classic">
              <figure class="post-classic-figure"><a class="link-img" href="#"><img src="img/photo9.jpg" alt="" width="360" height="240" loading="lazy" /></a>
              </figure>
              <div class="post-classic-body">
                <h4 class="post-classic-title"><a href="#">Expertise and Experience</a></h4>
          ...
          <div class="col-lg-4 col-sm-6">
            <article class="post-classic">
              <figure class="post-classic-figure"><a class="link-img" href="#"><img src="img/photo10.jpg" alt="" width="360" height="240" loading="lazy" /></a>
              </figure>
              <div class="post-classic-body">
                <h4 class="post-classic-title"><a href="#">Customized Solutions</a></h4>
                <p class="post-classic-text">
          ...
          <div class="col-lg-4 col-sm-6">
            <article class="post-classic">
              <figure class="post-classic-figure"><a class="link-img" href="#"><img src="img/photo18.jpg" alt="" width="360" height="240" loading="lazy" /></a>
              </figure>
              <div class="post-classic-body">
                <h4 class="post-classic-title"><a href="#">Quality and Innovation</a></h4>
                <p class="post-classic-text">
    ...
    <section class="section section-lg bg-light text-center pb-0">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 col-md-10">
            <h3>We're a passionate team working toward a better future for the planet.</h3>
            <p></p><a class="btn btn-white" href="team">Our Team</a>
          </div>
        </div>
      </div>
      <div class="img-about-wrap"><img src="img/team2.jpg" alt="" width="1433" height="512" loading="lazy" />
      </div>
    </section>
    ...
    <section style="display: none;" class="section section-lg bg-white text-center">
      <div class="container">
        <h5>Our Partners</h5>
        <h2>We Work with 20+ Companies</h2>
        <!-- Owl Carousel-->
        <div class="owl-carousel offset-lg" data-items="2" data-sm-items="3" data-md-items="4" data-lg-items="5" data-xl-items="6" data-owl="{&quot;autoplayTimeout&quot;:3500}">
          <div class="partner"><a href="#"><img src="images/partner-01-160x80.png" alt="" width="160" height="80" loading="lazy" /></a></div>
          <div class="partner"><a href="#"><img src="images/partner-02-160x80.png" alt="" width="160" height="80" loading="lazy" /></a></div>
          <div class="partner"><a href="#"><img src="images/partner-03-160x80.png" alt="" width="160" height="80" loading="lazy" /></a></div>
          <div class="partner"><a href="#"><img src="images/partner-04-160x80.png" alt="" width="160" height="80" loading="lazy" /></a></div>
          <div class="partner"><a href="#"><img src="images/partner-05-160x80.png" alt="" width="160" height="80" loading="lazy" /></a></div>
          <div class="partner"><a href="#"><img src="images/partner-06-160x80.png" alt="" width="160" height="80" loading="lazy" /></a></div>
        </div>
      </div>
    </section>

    <section class="section section-lg bg-white pt-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 col-md-10">
            <h3 class="text-center"><?php print $siteName; ?> has earned numerous awards since its establishment in 1999</h3>
            <div class="row row-30 offset-md">
              <div class="col-sm-6">
                <ul class="list-marked list-lg">
                  <li>
                    <p><span class="font-weight-bold">2005</span> - Solar Power Award for collaboration with community</p>
                  </li>
                  <li>
                    <p><span class="font-weight-bold">2010</span> - Intelegant Award for Excellence (Boston Business Awards)</p>
                  </li>
                  <li>
                    <p><span class="font-weight-bold">2011, 2012, 2013</span> - Inc. 1000 List</p>
                  </li>
                  <li>
                    <p><span class="font-weight-bold">2014, 2015, 2016</span> - B Corp Certified</p>
                  </li>
                </ul>
              </div>
              <div class="col-sm-6">
                <ul class="list-marked list-lg">
                  <li>
                    <p><span class="font-weight-bold">2017</span> - Top 100 on Inc 1000 List</p>
                  </li>
                  <li>
                    <p><span class="font-weight-bold">2018</span> - Best Residential Solar Power Contractor (Solar & Storage Live Awards)</p>
                  </li>
                  <li>
                    <p><span class="font-weight-bold">2019, 2020</span> - Residential Solar & Storage Project of the Year</p>
                  </li>
                  <li>
                    <p><span class="font-weight-bold">2019, <?php print $siteYear; ?></span> - PV America Photovoltaic Project of Distinction Award (Sullivan's Ledge)</p>
                  </li>
                </ul>
              </div>
            </div>
